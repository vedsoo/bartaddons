...
1./fme — open the FME GUI

2./fme toggle — toggle FME on/off

3./fme edit — toggle edit mode on/off

4./fme undo — undo last replace

GUI 5. /fme gui settings — open GUI settings screen

Config 6. /fme config load

7. /fme config load <name>

8. /fme config save

9. /fme config save <name>
...
15. /fme worldedit pos2

16. /fme worldedit pos2 <x> <y> <z>

17. /fme worldedit pos3
